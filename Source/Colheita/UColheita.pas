...
procedure TfrmColheita.GeraLista(Filtro:string);
var
 item   : TListViewItem;
 txt    : TListItemText;
 ...
 vStatus:string;
begin
  dmDB.AbreOperacaoSafra(Filtro+' and op.id=4');
...
procedure TfrmColheita.Image16Click(Sender: TObject);
begin
 Close;
end;

procedure TfrmColheita.Image18Click(Sender: TObject);
begin
 MudarAba(TabLista,sender)
end;

procedure TfrmColheita.Image27Click(Sender: TObject);
begin
  MudarAba(TabLista,sender);
end;

procedure TfrmColheita.Image31Click(Sender: TObject);
begin
 MudarAba(tbiDetalhes,sender);
end;

procedure TfrmColheita.Image3Click(Sender: TObject);
begin
   layEditaArea.Visible := false;
end;

procedure TfrmColheita.listaOperacaoGesture(Sender: TObject;
  const EventInfo: TGestureEventInfo; var Handled: Boolean);
begin
...
procedure TfrmColheita.listaOperacaoItemClickEx(const Sender: TObject;
  ItemIndex: Integer; const LocalClickPos: TPointF;
  const ItemObject: TListItemDrawable);
begin
 vIdOP :=
...
procedure TfrmColheita.ListaProdutosItemClickEx(const Sender: TObject;
  ItemIndex: Integer; const LocalClickPos: TPointF;
  const ItemObject: TListItemDrawable);
begin
 vIdProdutoSel :=
...
procedure TfrmColheita.listaTalhaoItemClickEx(const Sender: TObject;
  ItemIndex: Integer; const LocalClickPos: TPointF;
  const ItemObject: TListItemDrawable);
begin
  vIdTalhaoPull :=
...
procedure TfrmColheita.GeraListaMaquinas;
var
 item   : TListViewItem;
 txt    : TListItemText;
 txtH   : TListItemPurpose;
...
procedure TfrmColheita.SomarColunasHoras;
var
  Sum : Double;
  Val : Double;
  I   : Integer;
...
procedure TfrmColheita.GeraListaProdutos;
var
 item   : TListViewItem;
 txt    : TListItemText;
 txtH   : TListItemPurpose;
...
procedure TfrmColheita.GeraListaTalhao(IdPull:string);
var
 item   : TListViewItem;
 txt    : TListItemText;
 txtH   : TListItemPurpose;
...
procedure TfrmColheita.GeraListaOcorrencia;
var
 item   : TListViewItem;
 txt    : TListItemText;
 txtH   : TListItemPurpose;
...
procedure TfrmColheita.AbreDetalhesOp(vIdOp: string);
begin

end;

procedure TfrmColheita.btnAddMaquinaClick(Sender: TObject);
begin
...
procedure TfrmColheita.BtnAddTalhaoClick(Sender: TObject);
begin
  ...
  begin
    ...
    begin
      ...
      begin
       ShowMessage('Operação so permite um talhão');
       Exit;
      end;
...
procedure TfrmColheita.Rectangle63Click(Sender: TObject);
begin
try
...
function TfrmColheita.RetornaIdOperacao: integer;
var
 vId:integer;
 vId1:integer;
begin
...
procedure TfrmColheita.btnBuscarOperacaoClick(Sender: TObject);
begin
  laybtnLista.Visible := false;
  Filtrar;
end;

procedure TfrmColheita.btnConfirmaAreaClick(Sender: TObject);
begin
 try
...
procedure TfrmColheita.btnConfirmaOcorrenciaClick(Sender: TObject);
begin
...
procedure TfrmColheita.btnConfirmaProdutoClick(Sender: TObject);
begin
...
procedure TfrmColheita.btnConfirmaTalhaoClick(Sender: TObject);
var
...
begin
 ...
 begin
  ...
  dmDB.AtualizaAreaPrevPul(vIdPul);
   ...
   dmDB.TOperacaoSafraidoperacao.AsInteger    := 4;
...
procedure TfrmColheita.Filtrar;
var
 vFiltro:string;
begin
...
procedure TfrmColheita.btnEditaProdutoClick(Sender: TObject);
begin
...
procedure TfrmColheita.btnEditarClick(Sender: TObject);
begin
...
procedure TfrmColheita.btnEditarOpClick(Sender: TObject);
begin
 laybtnLista.Visible := false;
 vDetalhes := 1;
 if vIdOp.Length=0 then
...
procedure TfrmColheita.btnExcluiItemClick(Sender: TObject);
begin
 laybtnLista.Visible := false;
 if vFlagSync='1' then
 begin
...
procedure TfrmColheita.btnExcluirOcorrenciaClick(Sender: TObject);
begin
...
procedure TfrmColheita.btnExcluirProdutoClick(Sender: TObject);
begin
...
procedure TfrmColheita.btnExcluirTalhaoClick(Sender: TObject);
begin
...
procedure TfrmColheita.btnExluirMaquinaClick(Sender: TObject);
begin
...
procedure TfrmColheita.CarregaCombo;
begin
...
procedure TfrmColheita.cbxCoberturaChange(Sender: TObject);
begin
 if dmFunctions=nil then
   dmFunctions := TdmFunctions.Create(Self);
end;

procedure TfrmColheita.cbxCulturaAplChange(Sender: TObject);
begin
  if dmFunctions=nil then
   dmFunctions := TdmFunctions.Create(Self);
...
procedure TfrmColheita.cbxVariedadeChange(Sender: TObject);
begin
 if dmFunctions=nil then
  dmFunctions := TdmFunctions.Create(Self);
...
procedure TfrmColheita.btnFinalizarClick(Sender: TObject);
var
...
procedure TfrmColheita.btnMaquinasClick(Sender: TObject);
begin
...
procedure TfrmColheita.btnNovaMaquinaClick(Sender: TObject);
begin
 if vIdOPTipo='4' then
 begin
...
procedure TfrmColheita.btnNovaOcorrenciaClick(Sender: TObject);
begin
 LimpaCampos;
 dmDb.TOperacaoSafraOcorrencia.Close;
 dmDb.TOperacaoSafraOcorrencia.Open;
...
procedure TfrmColheita.btnNovoProdutoClick(Sender: TObject);
begin
 LimpaCampos;
 dmDB.TOperacaoSafraProdutos.Close;
 dmDB.TOperacaoSafraProdutos.Open;
...
procedure TfrmColheita.LimpaCampos;
begin
...
procedure TfrmColheita.ListaMaquinasItemClickEx(const Sender: TObject;
  ItemIndex: Integer; const LocalClickPos: TPointF;
  const ItemObject: TListItemDrawable);
begin
  vIdMaquinaSel :=
...
procedure TfrmColheita.ListaOcorrenciaItemClickEx(const Sender: TObject;
  ItemIndex: Integer; const LocalClickPos: TPointF;
  const ItemObject: TListItemDrawable);
begin
  vIdOcorrenciaSel :=
...
procedure TfrmColheita.btnOcorrenciaClick(Sender: TObject);
begin
 TThread.CreateAnonymousThread(procedure
  begin
   TThread.Synchronize(nil, procedure
...
procedure TfrmColheita.btnProdutosClick(Sender: TObject);
begin
  TThread.CreateAnonymousThread(procedure
  begin
   TThread.Synchronize(nil, procedure
...
procedure TfrmColheita.btnSalvaPuverizacaoClick(Sender: TObject);
begin
...
procedure TfrmColheita.btnTalhoesClick(Sender: TObject);
begin
 layBtnDet.Enabled := false;
 vDetalhes := 1;
...
procedure TfrmColheita.btnVoltaProdutoClick(Sender: TObject);
begin
 MudarAba(tbiDetalhes,sender);
end;

procedure TfrmColheita.Button12Click(Sender: TObject);
begin
 MudarAba(TabLista,sender);
end;

procedure TfrmColheita.Button16Click(Sender: TObject);
begin
 MudarAba(TabLista,sender);
end;

procedure TfrmColheita.Button1Click(Sender: TObject);
begin
 MudarAba(TabLista,sender);
end;

procedure TfrmColheita.Button2Click(Sender: TObject);
begin
 laybtnLista.Visible := false;
 vDetalhes := 0;
 vFinalizandoOP :=0;
...
procedure TfrmColheita.Button3Click(Sender: TObject);
begin
 MudarAba(tbiDetalhes,sender);
end;

procedure TfrmColheita.Button4Click(Sender: TObject);
begin
 MudarAba(tbiDetalhes,sender);
end;

procedure TfrmColheita.Button5Click(Sender: TObject);
begin
 MudarAba(TabLista,sender);
end;

procedure TfrmColheita.Button6Click(Sender: TObject);
begin
  MudarAba(TabLista,sender);
end;

procedure TfrmColheita.Button7Click(Sender: TObject);
begin
 MudarAba(TabLista,sender);
end;

procedure TfrmColheita.Button8Click(Sender: TObject);
begin
 MudarAba(tbiDetalhes,sender);
end;

procedure TfrmColheita.EditButton2Click(Sender: TObject);
begin
...
procedure TfrmColheita.EditButton4Click(Sender: TObject);
begin
...
procedure TfrmColheita.EditButton5Click(Sender: TObject);
begin
...
procedure TfrmColheita.EditButton7Click(Sender: TObject);
begin
...
procedure TfrmColheita.edtHoraFimChangeTracking(Sender: TObject);
begin
   edtHorasTrabalhada.Value := edtHoraFim.Value-edtHoraIni.Value;
end;

procedure TfrmColheita.edtHoraIniChangeTracking(Sender: TObject);
begin
  edtHorasTrabalhada.Value := edtHoraFim.Value-edtHoraIni.Value;
end;

procedure TfrmColheita.MudarAba(ATabItem: TTabItem; sender: TObject);
begin
  actMudarAba.Tab := ATabItem;
  actMudarAba.ExecuteTarget(sender);
end;

procedure TfrmColheita.FormClose(Sender: TObject; var Action: TCloseAction);
begin
 dmDB.vOpPull :=0;
end;

procedure TfrmColheita.FormShow(Sender: TObject);
begin
 laybtnLista.Visible       := false;
 frmColheita.StyleBook := frmPrincipal.StyleBook1;
 laybtnLista.Visible := false;
 GeraLista('');
 dmDB.TSafra.Close;
 dmDB.TSafra.Open;
