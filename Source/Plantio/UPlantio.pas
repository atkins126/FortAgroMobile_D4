...
procedure TfrmPlantio.GeraLista(Filtro:string);
var
 item   : TListViewItem;
 txt    : TListItemText;
 ...
 vStatus:string;
begin
  dmDB.AbreOperacaoSafra(Filtro+' and op.id in(3,6)');
     ...
     item := listaOperacao.Items.Add;
       ...
       begin
         ...
         begin
           ...
           if dmDb.TOperacaoSafraidoperacao.AsInteger=6 then
           begin
            img            := TListItemImage(Objects.FindDrawable('Image13'));
            img.Bitmap     := frmPrincipal.imgReplante.Bitmap;
...
procedure TfrmPlantio.Image16Click(Sender: TObject);
begin
 Close;
end;

procedure TfrmPlantio.Image18Click(Sender: TObject);
begin
 MudarAba(TabLista,sender)
end;

procedure TfrmPlantio.Image27Click(Sender: TObject);
begin
  MudarAba(TabLista,sender);
end;

procedure TfrmPlantio.Image31Click(Sender: TObject);
begin
 MudarAba(tbiDetalhes,sender);
end;

procedure TfrmPlantio.Image3Click(Sender: TObject);
begin
   layEditaArea.Visible := false;
end;

procedure TfrmPlantio.listaOperacaoGesture(Sender: TObject;
  const EventInfo: TGestureEventInfo; var Handled: Boolean);
begin
...
procedure TfrmPlantio.listaOperacaoItemClickEx(const Sender: TObject;
  ItemIndex: Integer; const LocalClickPos: TPointF;
  const ItemObject: TListItemDrawable);
begin
 vIdOP :=
...
procedure TfrmPlantio.ListaProdutosItemClickEx(const Sender: TObject;
  ItemIndex: Integer; const LocalClickPos: TPointF;
  const ItemObject: TListItemDrawable);
begin
 vIdProdutoSel :=
...
procedure TfrmPlantio.listaTalhaoItemClickEx(const Sender: TObject;
  ItemIndex: Integer; const LocalClickPos: TPointF;
  const ItemObject: TListItemDrawable);
begin
  vIdTalhaoPull :=
...
procedure TfrmPlantio.GeraListaMaquinas;
var
 item   : TListViewItem;
 txt    : TListItemText;
 txtH   : TListItemPurpose;
...
procedure TfrmPlantio.SomarColunasHoras;
var
  Sum : Double;
  Val : Double;
  I   : Integer;
...
procedure TfrmPlantio.GeraListaProdutos;
var
 item   : TListViewItem;
 txt    : TListItemText;
 txtH   : TListItemPurpose;
...
procedure TfrmPlantio.GeraListaTalhao(IdPull:string);
var
 item   : TListViewItem;
 txt    : TListItemText;
 txtH   : TListItemPurpose;
...
procedure TfrmPlantio.GeraListaOcorrencia;
var
 item   : TListViewItem;
 txt    : TListItemText;
 txtH   : TListItemPurpose;
...
procedure TfrmPlantio.AbreDetalhesOp(vIdOp: string);
begin

end;

procedure TfrmPlantio.btnAddMaquinaClick(Sender: TObject);
begin
...
procedure TfrmPlantio.BtnAddTalhaoClick(Sender: TObject);
begin
...
procedure TfrmPlantio.Rectangle63Click(Sender: TObject);
begin
try
...
function TfrmPlantio.RetornaIdOperacao: integer;
var
 vId:integer;
 vId1:integer;
begin
...
procedure TfrmPlantio.btnBuscarOperacaoClick(Sender: TObject);
begin
  laybtnLista.Visible := false;
  Filtrar;
end;

procedure TfrmPlantio.btnConfirmaAreaClick(Sender: TObject);
begin
 try
...
procedure TfrmPlantio.btnConfirmaOcorrenciaClick(Sender: TObject);
begin
...
procedure TfrmPlantio.btnConfirmaProdutoClick(Sender: TObject);
begin
...
procedure TfrmPlantio.btnConfirmaTalhaoClick(Sender: TObject);
var
...
begin
 ...
 begin
   ...
   ShowMessage('Operação Criada com Sucess!');
   MudarAba(TabLista,Sender);
 end
 else
 begin
 ...
 //atualiza operacao puverização master
  ...
  dmDB.TOperacaoSafratipoterraaereo.AsString := cbxTipoOperacao.Selected.Text;
  ...
  if cbxOperacao.ItemIndex=0 then
    dmDB.TOperacaoSafraidoperacao.AsInteger         := 3;
  if cbxOperacao.ItemIndex=1 then
    dmDB.TOperacaoSafraidoperacao.AsInteger         := 6;
...
procedure TfrmPlantio.btnEditaProdutoClick(Sender: TObject);
begin
...
procedure TfrmPlantio.btnEditarClick(Sender: TObject);
begin
...
procedure TfrmPlantio.btnEditarOpClick(Sender: TObject);
begin
 laybtnLista.Visible := false;
 vDetalhes := 1;
 if vIdOp.Length=0 then
...
procedure TfrmPlantio.btnExcluiItemClick(Sender: TObject);
begin
 laybtnLista.Visible := false;
 if vFlagSync='1' then
 begin
...
procedure TfrmPlantio.btnExcluirOcorrenciaClick(Sender: TObject);
begin
...
procedure TfrmPlantio.btnExcluirProdutoClick(Sender: TObject);
begin
...
procedure TfrmPlantio.btnExcluirTalhaoClick(Sender: TObject);
begin
...
procedure TfrmPlantio.btnExluirMaquinaClick(Sender: TObject);
begin
...
procedure TfrmPlantio.CarregaCombo;
begin
...
procedure TfrmPlantio.cbxCoberturaChange(Sender: TObject);
begin
...
procedure TfrmPlantio.cbxCulturaAplChange(Sender: TObject);
begin
  if dmFunctions=nil then
   dmFunctions := TdmFunctions.Create(Self);
...
procedure TfrmPlantio.cbxVariedadeChange(Sender: TObject);
begin
 if dmFunctions=nil then
  dmFunctions := TdmFunctions.Create(Self);
...
procedure TfrmPlantio.btnFinalizarClick(Sender: TObject);
var
 ...
 System.UITypes.TMsgDlgBtn.mbNo
  ...
  begin
     ...
     begin
      ...
      cbxTipoOperacao.Items.Clear;
      cbxTipoOperacao.Items.Add(dmDB.TOperacaoSafratipoterraaereo.AsString);
      cbxTipoOperacao.ItemIndex:=0;
...
procedure TfrmPlantio.btnMaquinasClick(Sender: TObject);
begin
...
procedure TfrmPlantio.btnNovaMaquinaClick(Sender: TObject);
begin
 if vIdOPTipo='4' then
 begin
...
procedure TfrmPlantio.btnNovaOcorrenciaClick(Sender: TObject);
begin
 LimpaCampos;
 dmDb.TOperacaoSafraOcorrencia.Close;
 dmDb.TOperacaoSafraOcorrencia.Open;
...
procedure TfrmPlantio.btnNovoProdutoClick(Sender: TObject);
begin
 LimpaCampos;
 dmDB.TOperacaoSafraProdutos.Close;
 dmDB.TOperacaoSafraProdutos.Open;
...
procedure TfrmPlantio.LimpaCampos;
begin
  ...
  cbxCobertura.ItemIndex           :=-1;
  cbxQualidadeCobertura.ItemIndex  :=-1;
  cbxVariedade.ItemIndex           :=-1;
end;

procedure TfrmPlantio.ListaMaquinasItemClickEx(const Sender: TObject;
  ItemIndex: Integer; const LocalClickPos: TPointF;
  const ItemObject: TListItemDrawable);
begin
  vIdMaquinaSel :=
...
procedure TfrmPlantio.ListaOcorrenciaItemClickEx(const Sender: TObject;
  ItemIndex: Integer; const LocalClickPos: TPointF;
  const ItemObject: TListItemDrawable);
begin
  vIdOcorrenciaSel :=
...
procedure TfrmPlantio.btnOcorrenciaClick(Sender: TObject);
begin
 TThread.CreateAnonymousThread(procedure
  begin
   TThread.Synchronize(nil, procedure
...
procedure TfrmPlantio.btnProdutosClick(Sender: TObject);
begin
  TThread.CreateAnonymousThread(procedure
  begin
   TThread.Synchronize(nil, procedure
...
procedure TfrmPlantio.btnSalvaPuverizacaoClick(Sender: TObject);
begin
 if cbxOperacao.ItemIndex=-1 then
 begin
   ShowMessage('Informe a Operacao!!');
 ...
 if cbxTipoOperacao.ItemIndex=-1 then
 begin
 ...
 if cbxCobertura.ItemIndex=-1 then
 begin
   ShowMessage('Informe a Cobertura!!');
   cbxCobertura.SetFocus;
   Exit;
 end;
 if cbxQualidadeCobertura.ItemIndex=-1 then
 begin
   ShowMessage('Informe a Qualidade Cobertura!!');
   cbxCobertura.SetFocus;
   Exit;
 end;
 ...
 begin
  ...
  try
    ...
    ShowMessage('Atividade Adicionada com sucesso, adicione os Talhoes');
 ...
 begin
  ...
  if edtDataFimPul.Date<edtDataIniAtividade.Date then
  begin
...
procedure TfrmPlantio.btnTalhoesClick(Sender: TObject);
begin
 layBtnDet.Enabled := false;
 vDetalhes := 1;
...
procedure TfrmPlantio.btnVoltaProdutoClick(Sender: TObject);
begin
 MudarAba(tbiDetalhes,sender);
end;

procedure TfrmPlantio.Button12Click(Sender: TObject);
begin
 MudarAba(TabLista,sender);
end;

procedure TfrmPlantio.Button16Click(Sender: TObject);
begin
 MudarAba(TabLista,sender);
end;

procedure TfrmPlantio.Button1Click(Sender: TObject);
begin
 MudarAba(TabLista,sender);
end;

procedure TfrmPlantio.Button2Click(Sender: TObject);
begin
 laybtnLista.Visible := false;
 vDetalhes := 0;
 vFinalizandoOP :=0;
...
procedure TfrmPlantio.Button3Click(Sender: TObject);
begin
 MudarAba(tbiDetalhes,sender);
end;

procedure TfrmPlantio.Button4Click(Sender: TObject);
begin
 MudarAba(tbiDetalhes,sender);
end;

procedure TfrmPlantio.Button5Click(Sender: TObject);
begin
 MudarAba(TabLista,sender);
end;

procedure TfrmPlantio.Button6Click(Sender: TObject);
begin
  MudarAba(TabLista,sender);
end;

procedure TfrmPlantio.Button7Click(Sender: TObject);
begin
 MudarAba(TabLista,sender);
end;

procedure TfrmPlantio.Button8Click(Sender: TObject);
begin
 MudarAba(tbiDetalhes,sender);
end;

procedure TfrmPlantio.EditButton2Click(Sender: TObject);
begin
...
procedure TfrmPlantio.EditButton4Click(Sender: TObject);
begin
...
procedure TfrmPlantio.EditButton5Click(Sender: TObject);
begin
...
procedure TfrmPlantio.EditButton7Click(Sender: TObject);
begin
...
procedure TfrmPlantio.edtHoraFimChangeTracking(Sender: TObject);
begin
   edtHorasTrabalhada.Value := edtHoraFim.Value-edtHoraIni.Value;
end;

procedure TfrmPlantio.edtHoraIniChangeTracking(Sender: TObject);
begin
  edtHorasTrabalhada.Value := edtHoraFim.Value-edtHoraIni.Value;
end;

procedure TfrmPlantio.MudarAba(ATabItem: TTabItem; sender: TObject);
begin
  actMudarAba.Tab := ATabItem;
  actMudarAba.ExecuteTarget(sender);
end;

procedure TfrmPlantio.FormClose(Sender: TObject; var Action: TCloseAction);
begin
 dmDB.vOpPull :=0;
end;
...
begin
 laybtnLista.Visible       := false;
 frmPlantio.StyleBook := frmPrincipal.StyleBook1;
 laybtnLista.Visible := false;
 GeraLista('');
 dmDB.TSafra.Close;
 dmDB.TSafra.Open;
